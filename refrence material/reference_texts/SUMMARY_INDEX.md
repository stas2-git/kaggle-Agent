...
See [`../codelabs/README.md`](../codelabs/README.md) for the project-level map.

## Original documents

PDF and RTF/RTFD originals live under [`../source_documents/`](../source_documents/). Each codelab's original PDF/RTF remains beside its runnable project because it is specific to that workspace.
