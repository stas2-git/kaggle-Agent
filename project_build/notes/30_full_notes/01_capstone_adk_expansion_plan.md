# Personal Build Plan: ADK Alignment

Prepared: 2026-06-22  
Plan status: Ready to follow  
Implementation status: Not started  
Controlling specifications: `.agents-cli-spec.md` and `capstone_spec_files/50_implementation/03_adk_alignment_notes.md`

## What this plan is for

Use this document as the practical build checklist for aligning the existing Actuarial Portfolio Monitoring Agent with ADK and Agents CLI. The goal is not to rebuild the project. The goal is to preserve the working actuarial engine and make the recognizable Google ADK structure demonstrated in the codelabs visible.
...
2. [ADK alignment notes](../../../capstone_spec_files/50_implementation/03_adk_alignment_notes.md)
3. [Agent architecture](../../../capstone_spec_files/10_core/02_agent_architecture.md)
4. [Tool contracts](../../../capstone_spec_files/20_contracts/02_tool_contracts.yaml)
5. [Behavior scenarios](../../../capstone_spec_files/20_contracts/03_behavior_spec.feature)
6. [Security specification](../../../capstone_spec_files/30_quality/01_security_privacy_spec.md)
7. [Evaluation specification](../../../capstone_spec_files/30_quality/03_evaluation_spec.yaml)
8. [Trace specification](../../../capstone_spec_files/30_quality/05_observability_trace_spec.md)
9. [Deployment and packaging](../../../capstone_spec_files/40_submission/05_deployment_spec.md)
10. [Gate 7](../../../capstone_spec_files/50_implementation/02_spec_adequacy_and_build_gates.md#18-gate-7--adk-and-agents-cli-alignment)
...
```text
capstone_spec_files/60_skills/portfolio_monitoring/
```
...
```text
README.md
assignment/10_submission/01_writeup/kaggle_writeup_draft.md
assignment/10_submission/02_video/video_script.md
assignment/10_submission/02_video/
artifacts/gate_results/gate_7_adk_upgrade.md
artifacts/gate_results/gate_6_submission_readiness.md
capstone_spec_files/90_archive/README.md
```
